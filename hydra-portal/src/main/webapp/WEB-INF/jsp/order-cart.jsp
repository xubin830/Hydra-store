...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/taotao-logo.gif" alt="JD商城"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="许彬"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="15669970077"/>
		<input type="hidden" name="orderShipping.receiverState" value="江苏省"/>
		<input type="hidden" name="orderShipping.receiverCity" value="南京市"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="江宁区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="弘景大道 3601号"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">许彬</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">15669970077</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">江苏省 南京市 江宁区</div>
						<div class="adr-m" limit="30">弘景大道 3601号</div>
...
<div class="shopping-list ABTest">
	<div class="goods-list">
     <!--配送方式-->
    <h4 class="vendor_name_h" id="0">商家：JD商城</h4>
		...
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">JD快递<i
						class='qmark-icon qmark-tip'
						data-tips='由JD公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
    ...
    <div class="ui-ceilinglamp checkout-buttons">
      ...
      <div class="sticky-wrap">
          ...
          <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
            部分商品货到付款方式：先由JD配送“提货单”并收款，然后厂商发货。
          </div>
        </div>
