 ...
 */
function login() {
    return location.href = "http://localhost:8004/user/showLogin";
}
function regist() {
    return location.href = "http://localhost:8004/user/showRegister";
}
...
function search(a) {
    var b = "http://localhost:8000/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
