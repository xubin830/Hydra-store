...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		URL_Serv: "http://127.0.0.1:8001/rest/itemcat/list?callback=category.getDataService",
		//URL_Serv: "http://localhost:82/category.json",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://www.xubin.vip" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
